...
#endif
#ifdef MM_PAGING
	struct mm_struct *mm;					// Quản lý bộ nhớ ảo
	struct memphy_struct *mram;				// Quản lý bộ nhớ RAM
	struct memphy_struct **mswp;			// Quản lý vùng SWAP
	struct memphy_struct *active_mswp;		// Vùng SWAP đang hoạt động
